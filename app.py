...
sp = pd.read_csv('./hogwart_specialtoken.csv')
sp_list = []
...
PATH = './poly_16_pytorch_model_48.bin'
...
with open('./train_data_source_hogwart_QA_aug_similar.pickle', 'rb') as f:
    train = pickle.load(f)
# with open('./dev_data_source_hogwart_QA_aug_similar.pickle', 'rb') as f:
#     dev = pickle.load(f)
